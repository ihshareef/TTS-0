...
def evaluate(model, criterion, ap, global_step, epoch):
    ...
    if args.rank == 0 and epoch > c.test_delay_epochs:
        if c.test_sentences_file is None:
            ...
            #]
            test_sentences = [
                ".ވަރައް ގިނަ ވަގުތުވި އަޑެއް އުފައްދަން. ދެނެއް ހަނަކުން ނުހުންނާނަން",
                ".ހުރިހާ  ބޭފުޅުންވެސް ގޭގާ ތިއްބަވާ",
                ".އަހަރެންނައްވެސް މިހާރު ވާހަކަ ދެއްކޭނެހެން ހީވޭ",
                ".އަހަންނަކީވެސް ދިރުމެއް ކަމައްވެދާނެ"
            ]
        else:
